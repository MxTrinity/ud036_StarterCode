...
pacific_rim = media.Movie("Pacific Rim",
              "When extra dimensional creatures known as Kaiju attack Earth, mankind builds the giant machines called Jaegers to fight them",
...
alien = media.Movie("Alien (1979)",
        "The crew of the mining ship Nostromo are awakened from cryo sleep to investigate a distress signal on an alien planet",
        "https://upload.wikimedia.org/wikipedia/en/c/c3/Alien_movie_poster.jpg",
        "https://www.youtube.com/watch?v=LjLamj-b0I8")

django = media.Movie("Django Unchained",
         "Django, a runaway slave joins Dr. Schultz a German Civil Ware era bounty hunter, on a mission to hunt down wanted criminals",
         "https://upload.wikimedia.org/wikipedia/en/8/8b/Django_Unchained_Poster.jpg",
         "https://www.youtube.com/watch?v=eUdM9vrCbow")

the_prestige = media.Movie("The Prestige",
               "Two rival magicians battling to create the ultimate illusion may inadvertently make the ultimate sacrifice.",
...
ghost_in_the_shell = media.Movie("Ghost in the Shell (1995)",
                     "Public security agent Motoko Kusinagi huntes down the notorious super hacker the puppet master.",
